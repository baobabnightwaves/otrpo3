...
<div class="mb-3">
    ...
    <input type="text" class="form-control rounded-0 text-dark @error('modal_title') is-invalid @enderror" 
...
<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="file" class="form-control rounded-0 text-dark @error('coat_of_arms_image') is-invalid @enderror" 
            ...
            @if(isset($city) && $city->coat_of_arms_image)
                <div class="mt-2">
                    <img src="{{ asset('storage/' . $city->coat_of_arms_image) }}" 
                         alt="Текущий герб" class="img-thumbnail rounded-0" style="max-height: 150px;">
                </div>
            @endif
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="file" class="form-control rounded-0 text-dark @error('city_image') is-invalid @enderror" 
            ...
            @if(isset($city) && $city->city_image)
                <div class="mt-2">
                    <img src="{{ asset('storage/' . $city->city_image) }}" 
                         alt="Текущее фото города" class="img-thumbnail rounded-0" style="max-height: 150px;">
                </div>
            @endif
        </div>
    </div>
...
<div class="mb-3">
    ...
    <input type="url" class="form-control rounded-0 text-dark @error('wiki_url') is-invalid @enderror" 
